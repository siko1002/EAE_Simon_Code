...
public class JsonStringToBookObject {
    ...
    public static List<Api_Book> parseJsonToBooks(String jsonString) {
        List<Api_Book> ret = new ArrayList<Api_Book>();
        try {
            JSONArray jsonArray = new JSONObject(jsonString).getJSONArray("docs");
    ...
    public static SearchResultStorage parseJsonToBooks(String jsonString, SearchResultStorage searchResultStorage) {
        try {
